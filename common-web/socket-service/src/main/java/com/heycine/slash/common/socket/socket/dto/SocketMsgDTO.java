...
public class SocketMsgDTO {
	 ...
	 * 登录挤退
	 */
	public static final String LOGIN_EXIT = "101";
	/**
	 * 通知消息
	 */
	public static final String NOTIFY_MESSAGE = "202";
	/**
	 * 通信数据
	 */
	public static final String TRANSFER_DATA = "303";
	/**
	 * 日志消息
	 */
	public static final String LOG_DATA = "404";
